    ...
    <>
      ...
      <main className="px-6 pb-20">
        <section className="grid grid-cols-1 gap-8 md:grid-cols-[2fr_1fr]">
          <article className="rounded-3xl border border-zinc-800 bg-white p-10">
            ...
            <nav className="mt-10 flex flex-wrap gap-4">
              <span className="rounded-full border border-black px-6 py-3">
                🎓 Pendidikan
              </span>
          ...
          <aside className="flex flex-col gap-8">
            <header className="rounded-3xl border border-zinc-800 bg-gray-300 p-10 text-center">
            ...
            <nav className="rounded-3xl border border-zinc-800 bg-gray-300 p-10">
              <h1 className="mb-8 text-center text-3xl font-bold">Download</h1>

              <button className="mb-4 h-14 w-full rounded-xl border border-gray-300 transition hover:bg-white hover:text-black">
                Download CV
              </button>

              <button className="h-14 w-full rounded-xl border border-gray-300 transition hover:bg-white hover:text-black">
                Download Resume
              </button>
            </nav>
          </aside>
